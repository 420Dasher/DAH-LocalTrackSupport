...
**SpotifyTrackHonorific v1.0.1** is the active standalone plugin. It talks directly to Spotify's Web API and Honorific and does not depend on DiscordActivityHonorific or Discord.
