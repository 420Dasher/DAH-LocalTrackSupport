...
$newEntry = [pscustomobject][ordered]@{
    ...
    Changelog = 'SpotifyTrackHonorific 1.0.7 adds privacy-safe one-click diagnostics copying for easier support and bug reports, with no core playback behavior changes.'
    AcceptsFeedback = $false
