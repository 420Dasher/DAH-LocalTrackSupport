...
$newEntry = [pscustomobject][ordered]@{
    ...
    Changelog = 'SpotifyTrackHonorific 1.0.11 expands saved-profile management with Update, Rename, Duplicate, and Move controls; reordered profiles also reorder Home-tab Quick profile buttons.'
    AcceptsFeedback = $false
