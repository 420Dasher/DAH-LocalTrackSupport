...
$newEntry = [pscustomobject][ordered]@{
    ...
    Changelog = 'SpotifyTrackHonorific 1.0.9 adds a title format builder with clickable variable insertion, copy/reset actions, cycle generation, and malformed-cycle warnings.'
    AcceptsFeedback = $false
