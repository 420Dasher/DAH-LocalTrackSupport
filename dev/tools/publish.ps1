...
$newEntry = [pscustomobject][ordered]@{
    ...
    Changelog = 'SpotifyTrackHonorific 1.0.8 improves custom blacklist management with scoped quick-add, search, deduplication, per-entry removal, clean/sort tools, and field-specific matcher testing.'
    AcceptsFeedback = $false
